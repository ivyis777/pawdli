...
class UpdateAdoptionPetController extends GetxController {
  ...
  Future<Editadoptionmodel?> updatePet(Editadoptionmodel model, String petId) async {
    if (petId.isEmpty) {
    ...
    try {
      ...
      final result = await ApiService.updateAdoptionPetProfile(model, petId);
